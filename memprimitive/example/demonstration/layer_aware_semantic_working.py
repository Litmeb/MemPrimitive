...
From the repo root (recommended)::
    ...
    python -m memprimitive.example.demonstration.layer_aware_semantic_working

Or from this directory (script adds the repo root to ``sys.path``)::

    python layer_aware_semantic_working.py
"""
...
# Running as ``python memprimitive/example/demonstration/layer_aware_semantic_working.py`` leaves ``__package__`` unset; repo root must be on path.
